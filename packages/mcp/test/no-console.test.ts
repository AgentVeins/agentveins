...
// cwd, so the scan finds the same sources however vitest was invoked. It matters most here:
// this package is an MCP server where stdout is the protocol, so a stray console write does
// not just look untidy — it corrupts the session.
